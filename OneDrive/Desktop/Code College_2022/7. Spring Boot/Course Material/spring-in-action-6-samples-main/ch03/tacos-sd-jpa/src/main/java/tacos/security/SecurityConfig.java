...
public class SecurityConfig {
	@Bean
	public PasswordEncoder passwordEncoder() { // Used when creating new users and authenticating at login
	 ...
	 * User("buzz", encoder.encode("password"), Arrays.asList(new
	 * SimpleGrantedAuthority("ROLE_USER")))); usersList.add( new User("woody",
	 * encoder.encode("password2"), Arrays.asList(new
