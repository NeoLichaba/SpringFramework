...
import org.springframework.web.bind.annotation.PostMapping; //HTTP Post requests
import org.springframework.web.bind.annotation.RequestMapping; //Request Handling
...
@Slf4j // Generate a logger - display information
@Controller
...
public class DesignTacoController {
	...
	@ModelAttribute // Data placed on model passed to the view
	public void addIngredientsToModel(Model model) {
		Iterable<Ingredient> ingredients = ingredientRepo.findAll();
		/*List<Ingredient> ingredients = Arrays.asList( // Array stores as a list
